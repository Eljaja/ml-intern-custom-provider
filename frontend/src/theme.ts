...
const darkVars = {
  ...
  '--text': '#E6EEF8',
  '--muted-text': '#98A0AA',
  // Brand (Singularity Compute) — purple; name kept for existing var(--accent-*) references
  '--accent-yellow': '#7B3FE4',
  '--accent-yellow-weak': 'rgba(123, 63, 228, 0.12)',
  '--accent-green': '#2FCC71',
  '--accent-red': '#E05A4F',
  '--shadow-1': '0 6px 18px rgba(2,6,12,0.55)',
  '--radius-lg': '20px',
  '--radius-md': '12px',
  '--focus': '0 0 0 3px rgba(123, 63, 228, 0.22)',
...
const lightVars = {
  ...
  '--radius-lg': '20px',
  '--radius-md': '12px',
  '--focus': '0 0 0 3px rgba(123, 63, 228, 0.2)',
...
export const darkTheme = createTheme({
  palette: {
    mode: 'dark',
    primary: { main: '#7B3FE4', light: '#9B5DF5', dark: '#5A2FC4', contrastText: '#fff' },
    secondary: { main: '#9B5DF5' },
